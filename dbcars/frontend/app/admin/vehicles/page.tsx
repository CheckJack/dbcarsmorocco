  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">Vehicles Management</h1>
          <p className="text-gray-400 text-sm sm:text-base md:text-lg">Manage your fleet of rental vehicles</p>
        </div>
        <button
      ...
      {/* Filters Section */}
      <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-sm mb-6 p-4 sm:p-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-semibold text-gray-300 mb-2">Search Vehicles</label>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-gray-700 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all bg-gray-800 text-white appearance-none"
              >
      ...
      {loading ? (
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-sm overflow-visible">
                ...
                return (
                  ...
                  >
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                        <div className="flex-shrink-0 h-16 xl:h-20 w-24 xl:w-28 rounded-xl overflow-hidden border-2 border-gray-800 shadow-sm">
                        {imageUrl ? (
                          <img
                            src={imageUrl}
                    ...
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      ...
                      <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <Tag className="w-3.5 xl:w-4 h-3.5 xl:h-4 text-gray-400" />
                          <span className="text-xs xl:text-sm font-medium text-gray-300 capitalize">
                      ...
                      <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <div className="p-1.5 bg-gray-800 rounded-lg">
                            <Package className="w-3 xl:w-3.5 h-3 xl:h-3.5 text-gray-400" />
                          </div>
                          <div className="text-xs xl:text-sm">
                            <span className="font-bold text-white">{vehicle.available_count || 0}</span>
                            <span className="text-gray-500"> / </span>
                            <span className="text-gray-300">{vehicle.subunit_count || 0}</span>
                          </div>
                        </div>
                  </td>
                  <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                        {vehicle.is_active ? (
                          <span className="inline-flex items-center gap-1.5 px-2 xl:px-3 py-1 bg-gradient-to-br from-emerald-50 to-green-50 text-emerald-700 border border-emerald-200 rounded-full text-xs font-semibold shadow-sm">
                            <CheckCircle2 className="w-3 xl:w-3.5 h-3 xl:h-3.5" />
                            Active
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-1.5 px-2 xl:px-3 py-1 bg-gradient-to-br from-red-900 to-rose-900 text-red-300 border border-red-800 rounded-full text-xs font-semibold shadow-sm">
              ...
              return (
                ...
                >
                  <div className="flex gap-4 mb-3">
                    <div className="flex-shrink-0 h-24 w-32 rounded-xl overflow-hidden border-2 border-gray-800 shadow-sm">
                      {imageUrl ? (
                        <img
                          src={imageUrl}
                          alt={`${vehicle.make} ${vehicle.model}`}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-1.5 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-400 capitalize">{vehicle.category || 'N/A'}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Euro className="w-3.5 h-3.5 text-gray-400" />
                          <span className="font-bold text-white">{formatCurrency(Number(vehicle.base_price_daily || 0))}</span>
          ...
          {/* Summary Footer */}
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 px-4 sm:px-6 py-4 border-t border-gray-800">

    ...
    <>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">Edit Vehicle</h1>
            <p className="text-gray-400 text-lg">Update vehicle information and settings</p>
          </div>
          <button
            onClick={() => router.back()}
            className="px-4 py-2 bg-gray-900 border border-gray-800 rounded-xl hover:bg-gray-800 transition-all font-semibold flex items-center gap-2 shadow-sm hover:shadow-md text-gray-300"
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-sm p-6">
          <div className="flex items-center gap-3 mb-4">
            <h3 className="text-xl font-bold text-white">Available Extras</h3>
          </div>
          <div className="border-2 border-gray-800 rounded-xl p-4 max-h-64 overflow-y-auto">
            {extras.length === 0 ? (
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-sm p-6">
          <div className="flex items-center gap-3 mb-4">
            <div>
              <h3 className="text-xl font-bold text-white">Vehicle Unit Information</h3>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-sm p-6">
          <div className="flex gap-4">
            ...
            <button
              type="button"
              onClick={() => router.back()}
              className="px-6 py-3 bg-gray-900 border border-gray-800 text-gray-300 rounded-xl hover:bg-gray-800 transition-all font-semibold flex items-center gap-2 shadow-sm hover:shadow-md"
            >
              <X className="w-5 h-5" />
              Cancel
            </button>

  ...
  return (
    <>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-4 border-t border-gray-800">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gray-700 text-gray-300 rounded-xl hover:bg-gray-700 transition-all font-semibold flex items-center gap-2"
                >
                  <X className="w-4 h-4" />
                  Cancel
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-white mt-1">{customer.email}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-white mt-1">{customer.phone}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-white mt-1">{formatDate(customer.date_of_birth)}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <label className="text-sm font-semibold text-gray-400">License Number</label>
                  <p className="font-medium text-white mt-1">{customer.license_number || 'N/A'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <label className="text-sm font-semibold text-gray-400">License Country</label>
                  <p className="font-medium text-white mt-1">{customer.license_country || 'N/A'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <label className="text-sm font-semibold text-gray-400">License Expiry</label>
                  <p className="font-medium text-white mt-1">{formatDate(customer.license_expiry)}</p>
                </div>
              </div>
              ...
              {customer.is_blacklisted && customer.blacklist_reason && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <label className="text-sm font-semibold text-gray-400">Blacklist Reason</label>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-800 bg-gradient-to-r from-gray-900 to-gray-800">
          <h2 className="text-xl font-bold text-white">Reservation History</h2>
        </div>
      ...
      {showBlacklistModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div
              className="relative bg-gray-900 rounded-2xl shadow-xl max-w-md w-full overflow-hidden"
              ...
              <div className="p-6">
                <div className="mb-4">
                  <p className="text-gray-400 mb-2">
                    Customer: <span className="font-semibold text-white">{customer.first_name} {customer.last_name}</span>
                  </p>
                </div>
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-gray-800 text-white placeholder-gray-400 border border-gray-700 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all resize-none"
                      rows={4}
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-gray-700 text-gray-300 rounded-xl hover:bg-gray-700 transition-all font-semibold flex items-center justify-center gap-2"
                  >
                    <X className="w-4 h-4" />
                    Cancel
                  </button>

                      ...
                      <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                        {bookingDetails.status === 'pending' && (
                          <button
                            ...
                            className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-xl hover:from-emerald-700 hover:to-green-700 transition-all text-sm sm:text-base lg:text-lg font-semibold shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                          >
                        ...
                        {bookingDetails.status === 'waiting_payment' && (
                          <button
                            ...
                            className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl hover:from-blue-700 hover:to-blue-600 transition-all text-sm sm:text-base lg:text-lg font-semibold shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                          >
                            <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5" />
                            Mark as Confirmed
                          </button>
                        ...
                        {bookingDetails.status === 'confirmed' && (
                          <button
                            ...
                            className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-gray-800 to-gray-700 text-white rounded-xl hover:from-gray-900 hover:to-gray-800 transition-all text-sm sm:text-base lg:text-lg font-semibold shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                          >
                            <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5" />
                            Mark as Completed
                          </button>
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-xl hover:from-red-700 hover:to-red-600 transition-all text-sm sm:text-base lg:text-lg font-semibold shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                        >

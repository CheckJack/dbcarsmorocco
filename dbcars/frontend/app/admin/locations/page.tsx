  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">Locations Management</h1>
          <p className="text-gray-400 text-sm sm:text-base md:text-lg">Manage pickup and drop-off locations for rentals</p>
        </div>
        <button
          onClick={() => {
            setShowForm(true);
            ...
            <table className="min-w-full divide-y divide-gray-800 hidden lg:table">
              ...
              <tbody className="bg-gray-900 divide-y divide-gray-800">
                {locations.map((location) => (
                  <tr key={location.id} className="hover:bg-gray-800 transition-colors">
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <div className="p-1.5 bg-blue-100 rounded-lg">
                          <MapPin className="w-3.5 xl:w-4 h-3.5 xl:h-4 text-blue-600" />
                        </div>
                        <div>
                          <div className="text-xs xl:text-sm font-bold text-white">{location.name}</div>
                          {location.email && (
                    ...
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <Building2 className="w-3.5 xl:w-4 h-3.5 xl:h-4 text-gray-400" />
                        <div>
                          <div className="text-xs xl:text-sm font-medium text-white">{location.city}</div>
                    ...
                    <td className="px-4 xl:px-6 py-3 xl:py-4">
                      <div className="flex items-start gap-2">
                        <Navigation className="w-3.5 xl:w-4 h-3.5 xl:h-4 text-gray-400 mt-0.5" />
                        <div className="text-xs xl:text-sm text-gray-300 max-w-xs">
                    ...
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      {location.phone ? (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs xl:text-sm text-gray-300">{location.phone}</span>
                        </div>
                      ) : (
                        <span className="text-xs xl:text-sm text-gray-400">N/A</span>
                      )}
                    </td>
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      {location.is_active ? (
                    ...
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs xl:text-sm text-gray-400">{formatDate(location.created_at)}</span>
                      </div>
                    </td>
              ...
              <div key={location.id} className="p-4">
                ...
                <div className="space-y-2 text-sm mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400">{formatDate(location.created_at)}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-gray-800 text-white placeholder-gray-400 border border-gray-700 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all resize-none"
                      rows={3}
                      required

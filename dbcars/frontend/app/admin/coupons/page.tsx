...
export default function AdminCouponsPage() {
  ...
  const getUsageDisplay = (usageCount: number, usageLimit: number | null) => {
      ...
      return (
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-white">{usageCount}/{usageLimit}</span>
          </div>
    ...
    return (
      <div className="flex items-center gap-2">
        <Users className="w-3.5 h-3.5 text-gray-400" />
        <span className="text-sm font-medium text-gray-300">{usageCount} <span className="text-gray-500">(unlimited)</span></span>
      </div>
    );
  };
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-sm overflow-visible">
                      ...
                      <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <div className="p-1.5 bg-orange-100 rounded-lg">
                            <Ticket className="w-3.5 xl:w-4 h-3.5 xl:h-4 text-orange-600" />
                          </div>
                          <div>
                            <div className="text-xs xl:text-sm font-bold font-mono text-white">{coupon.code}</div>
                            {coupon.description && (
                      ...
                      <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                        <div className="flex items-center gap-1">
                          {coupon.discount_type === 'percentage' ? (
                            <Percent className="w-3.5 xl:w-4 h-3.5 xl:h-4 text-gray-400" />
                          ) : (

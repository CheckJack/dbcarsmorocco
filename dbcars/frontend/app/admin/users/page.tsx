  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">Users Management</h1>
          <p className="text-gray-400 text-sm sm:text-base md:text-lg">Manage admin users and their permissions</p>
        </div>
        <button
          onClick={() => {
            setShowForm(true);
                  ...
                  <tr key={user.id}>
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <div className="p-1.5 bg-gray-800 rounded-full">
                          <User className="w-3 xl:w-3.5 h-3 xl:h-3.5 text-gray-400" />
                        </div>
                        <span className="text-xs xl:text-sm font-medium text-white">{user.name}</span>
                      </div>
                    </td>
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <Mail className="w-3.5 xl:w-4 h-3.5 xl:h-4 text-gray-400" />
                        <span className="text-xs xl:text-sm text-gray-300">{user.email}</span>
                      </div>
                    </td>
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      <span className="px-2 xl:px-3 py-1 text-xs font-semibold rounded-full border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 text-blue-700 shadow-sm inline-flex items-center gap-1.5">
                        <Shield className="w-3 xl:w-3.5 h-3 xl:h-3.5" />
                        {user.role}
                      </span>
                    </td>
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs xl:text-sm text-gray-400">{formatDate(user.created_at)}</span>
                      </div>
                    </td>
                    <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                      <div className="relative" ref={(el) => (menuRefs.current[user.id] = el)}>
                        ...
                        {openMenuId === user.id && (
                          <div className="absolute right-0 mt-1 w-40 bg-gray-900 border border-gray-800 rounded-xl shadow-lg z-10 py-1">
                            <button
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 overflow-y-auto p-2 sm:p-4">
          ...
          <div className="flex min-h-full items-center justify-center">
            <div
              className="relative bg-gray-900 rounded-2xl shadow-xl max-w-md w-full overflow-hidden max-h-[90vh] overflow-y-auto"

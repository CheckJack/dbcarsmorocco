  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl shadow-sm border border-zinc-800 p-4 mb-6">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="relative" ref={filterDropdownRef}>
                ...
                {showFilters && (
                  <div className="fixed sm:absolute left-0 right-0 sm:right-0 sm:left-auto top-0 sm:top-auto sm:mt-2 w-full sm:w-96 bg-zinc-900 rounded-none sm:rounded-xl shadow-2xl border-0 sm:border border-zinc-800 z-[100] h-screen sm:h-auto sm:max-h-[80vh] overflow-y-auto">

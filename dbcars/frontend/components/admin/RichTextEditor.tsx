...
const RichTextEditor = ({ content, onChange, placeholder = 'Write your blog post content here...' }: RichTextEditorProps) => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'focus:outline-none min-h-[400px] px-4 py-3 text-white [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:mb-4 [&_h1]:mt-6 [&_h1]:text-white [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mb-3 [&_h2]:mt-5 [&_h2]:text-white [&_h3]:text-xl [&_h3]:font-bold [&_h3]:mb-2 [&_h3]:mt-4 [&_h3]:text-white [&_h4]:text-lg [&_h4]:font-bold [&_h4]:mb-2 [&_h4]:mt-3 [&_h4]:text-white [&_p]:mb-4 [&_p]:leading-relaxed [&_p]:text-white [&_ul]:list-disc [&_ul]:ml-6 [&_ul]:mb-4 [&_ol]:list-decimal [&_ol]:ml-6 [&_ol]:mb-4 [&_li]:mb-2 [&_li]:text-white [&_blockquote]:border-l-4 [&_blockquote]:border-gray-700 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:my-4 [&_blockquote]:text-white [&_code]:bg-gray-800 [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-sm [&_code]:text-white [&_img]:rounded-lg [&_img]:my-4 [&_img[width]]:max-w-none [&_img[height]]:h-auto [&_img:not([width])]:max-w-full [&_img:not([width])]:h-auto [&_a]:text-blue-400 [&_a]:underline [&_.ProseMirror-selectednode]:outline-none [&_*]:outline-none',
      },
    },
  });
    ...
    <button
      ...
      className={`p-2 rounded-lg transition-all ${
        isActive
          ...
          : 'text-gray-600 hover:bg-gray-800 hover:text-gray-900'
  ...
  return (
    <div className="border border-gray-700 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-orange-500 focus-within:border-orange-500 transition-all">
      {/* Toolbar */}
      <div className="bg-gray-800 border-b border-gray-800 p-2 flex flex-wrap items-center gap-1">
        {/* Text Formatting */}
        ...
        <div className="flex items-center gap-1">
          <select
            ...
            className="px-2 py-1.5 text-sm border border-gray-700 rounded-lg bg-gray-900 text-gray-300 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
            title="Font Family"
            defaultValue=""
          >
      ...
      {showHtmlView ? (
        ...
        <div className="relative bg-gray-900 min-h-[400px] text-white">
      ...
      {showImageDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 rounded-2xl shadow-xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="p-1 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-800 transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {imageUrl && (
                  <div className="border border-gray-800 rounded-lg p-4 bg-gray-800 flex items-center justify-center min-h-[200px]">
                    <img
                      src={imageUrl}
                      alt="Preview"
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      <button
                        ...
                        className="px-3 py-2 text-sm border border-gray-700 rounded-lg hover:bg-gray-800 hover:border-orange-500 transition-all"
                      >
                        {preset.label}
                      </button>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <input
                      ...
                      value={imageWidth}
                      onChange={(e) => handleImageDimensionChange('width', e.target.value)}
                      className="flex-1 px-3 py-1.5 text-sm border border-gray-700 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all"
                      placeholder="Auto"
                      min="1"
                    />
                    <button
                      onClick={() => setImageWidth('')}
                      className="px-3 py-1.5 text-xs text-gray-400 hover:text-gray-300 hover:bg-gray-800 rounded-lg transition-all"
                    >
                      Clear
                    </button>
                  </div>
                ...
                <div className="flex items-center pt-2">
                  <input
                    ...
                    className="h-5 w-5 text-orange-600 focus:ring-orange-500 border-gray-700 rounded"
                  />
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-gray-800 text-gray-300 rounded-xl hover:bg-gray-700 transition-all font-semibold"
                  >
                    Cancel
                  </button>
                  <button
      ...
      {showLinkDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 rounded-2xl shadow-xl max-w-md w-full p-6">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-700 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all"

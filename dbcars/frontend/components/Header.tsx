  ...
  return (
    ...
    >
      <nav className="container mx-auto px-4 md:px-6 py-4 bg-transparent">
        ...
        <div
          ref={mobileMenuRef}
          className={`fixed top-0 right-0 bottom-0 w-[280px] bg-black/95 backdrop-blur-lg z-50 md:hidden transform transition-transform duration-300 ease-in-out ${
            isMenuOpen ? 'translate-x-0' : 'translate-x-full'
          } border-l border-white/10 shadow-2xl overflow-y-auto`}
        >
          {/* Logo in Mobile Menu */}
          <div className="flex justify-center items-center pt-6 pb-4 px-6 border-b border-white/10">
            <Link
              href="/"
              onClick={() => setIsMenuOpen(false)}

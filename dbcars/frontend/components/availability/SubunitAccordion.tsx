  ...
  return (
    <div className="space-y-2">
      {subunits.map((subunit) => (
        <div
          key={subunit.id}
          className="bg-gray-900 border border-gray-800 rounded-lg p-2.5 text-xs"
        >
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {onStatusChange && (
              <select
                ...
                className="text-xs px-2 py-1 rounded border border-gray-700 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all bg-gray-900"
              >

    ...
    <div className="px-6 py-4">
      <div className="flex items-center gap-4 flex-wrap">
        ...
        <select
          ...
          className="text-sm px-4 py-2 border border-gray-700 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all bg-gray-900 appearance-none font-medium"
        >
        ...
        {activeFilterCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-gray-300 bg-gray-800 rounded-xl hover:bg-gray-200 transition-all"
          >
            <X className="w-4 h-4" />
            Clear Filters
          </button>

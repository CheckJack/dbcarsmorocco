...
export default function QuickActionMenu({
  ...
  return (
    <div
      ref={menuRef}
      className="fixed z-50 bg-gray-900 rounded-lg shadow-xl border border-gray-800 py-1 min-w-[180px]"
      ...
      {menuItems.map((item, index) => {
        ...
        return (
          <button
            ...
            className="w-full px-4 py-2 text-sm text-left text-gray-300 hover:bg-gray-800 transition-colors flex items-center gap-2"
          >

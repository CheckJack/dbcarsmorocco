          ...
          {menuItems.map((item, index) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 bg-gray-900 text-white rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105 whitespace-nowrap"
              >

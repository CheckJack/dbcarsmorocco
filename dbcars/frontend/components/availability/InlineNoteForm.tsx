...
export default function InlineNoteForm({
  ...
  return (
    <div
      ref={formRef}
      className={`
        fixed z-50 bg-gray-900 rounded-xl shadow-2xl border border-gray-800 p-3 sm:p-4 w-[calc(100vw-2rem)] sm:w-[320px] max-w-[320px]
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          ...
          <div className="relative">
            ...
            <DatePicker
              ...
              className="w-full pl-8 pr-3 py-2 text-xs bg-gray-800 text-white placeholder-gray-400 border border-gray-700 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
        ...
        <div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-8 pr-3 py-2 text-xs bg-gray-800 text-white border border-gray-700 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 appearance-none"
              required
            >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <textarea
              ...
              className="w-full pl-8 pr-3 py-2 text-xs bg-gray-800 text-white placeholder-gray-400 border border-gray-700 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 resize-none"
              rows={3}
        ...
        <div className="flex gap-2 pt-2">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-3 py-2 bg-gray-800 text-gray-300 text-xs font-semibold rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center"
          >

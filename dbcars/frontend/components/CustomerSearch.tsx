    ...
    <div ref={wrapperRef} className="relative">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 pl-10 border border-gray-700 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 bg-gray-900 text-white placeholder-gray-500"
        />
        <svg
      ...
      {showResults && results.length === 0 && query.length >= 2 && !isSearching && (
        <div className="absolute z-50 w-full mt-1 bg-gray-900 border border-gray-700 rounded-lg shadow-lg p-4 text-center text-gray-400">
